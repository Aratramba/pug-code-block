...
var fs = require('fs');
var beforeBlockAtLine = require('../index').beforeBlockAtLine;
...
test('Before block at line', function(assert){
  var actual = beforeBlockAtLine(source, 6);
...
test('Before block at line', function(assert){
  var actual = beforeBlockAtLine(source, 36);
  var expected = '  div\n    | foo\n    | faa';
...
test('Before block at line: none', function(assert){
  var actual = beforeBlockAtLine(source, 12);
  var expected = '';
...
test('Before block at line: linenumber less than 0', function(assert){
  var actual = beforeBlockAtLine(source, 0);
  var expected = '';
...
test('Before block at line: linenumber 1', function(assert){
  var actual = beforeBlockAtLine(source, 1);
  var expected = '';
...
test('Before block at line: linenumber out of range', function(assert){
  var actual = beforeBlockAtLine(source, 100);
  var expected = '';
